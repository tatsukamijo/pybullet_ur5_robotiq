...
class PegInHole:
    ...
    def __init__(self, camera: Camera, vis=False, gripper_type='85') -> None:
        self.vis = vis
        self.camera = camera
        ...
        self.cubeID = p.loadURDF("./urdf/objects/block.urdf",
                                    [np.clip(np.random.normal(0, 0.005), -0.2, 0.2),
        ...
        self.digit_links = [self.joints['left_inner_finger_pad_joint'].id, self.joints['right_inner_finger_pad_joint'].id]
...
class ClutteredPushGrasp:
    ...
    def __init__(self, models: Models, camera: Camera, vis=False, num_objs=3, gripper_type='85') -> None:
        ...
        self.robotID = p.loadURDF("./urdf/ur5_robotiq_%s.urdf" % gripper_type,
                                  ...
                                  useFixedBase=True,
                                  flags=p.URDF_USE_INERTIA_FROM_FILE)
        self.cubeID = p.loadURDF("./urdf/objects/cube_small.urdf",
                                    [1.0, 1.0, 1.0],
                                    p.getQuaternionFromEuler([0, 0, 0]),
                                    useFixedBase=True)
